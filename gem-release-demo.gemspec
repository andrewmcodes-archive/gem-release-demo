...
require_relative "lib/gem/release/demo/version"

Gem::Specification.new do |spec|
  spec.name = "gem-release-demo"
  spec.version = Gem::Release::Demo::VERSION
  spec.authors = ["Andrew Mason"]
  spec.email = ["andrewmcodes@protonmail.com"]

  spec.summary = "Gem Release Demo Summary"
  spec.description = "Gem Release Demo Description"
